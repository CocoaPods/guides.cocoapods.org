...
It's like saying we should not have cars, as they make us lazy and we forget walking/running. Or we should not have auto-complete and syntax-highlighting in an IDE as they make us bad programmers, who can't code in editor and can't remember syntax. Furthermore, this reasoning applies to basically any means of fetching code (e.g. git) and as such is not a discussion worth having.
